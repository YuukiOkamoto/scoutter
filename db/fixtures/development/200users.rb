(1..100).each do |i|
  User.seed(:id) do |s|
    ...
    if i % 3 == 0
      ...
      s.image = "https://abs.twimg.com/sticky/default_profile_images/default_profile_normal.png"
    elsif i % 20 == 0
      s.image = "https://pbs.twimg.com/profile_images/1030013851058679808/C5xBgScL.jpg"
    else
      s.image = "https://pbs.twimg.com/profile_images/1051707879269363712/82Rqsma8_normal.jpg"
    end
  end
end
