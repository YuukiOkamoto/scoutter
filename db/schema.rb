...
ActiveRecord::Schema.define(version: 2018_11_03_132614) do
  ...
  create_table "action_qualities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.bigint "action_id"
    t.integer "minimum"
    t.integer "maximum"
    t.integer "quality"
  ...
  create_table "characters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "name"
    t.text "introduction"
    t.bigint "minimum"
    t.bigint "maximum"
  ...
  create_table "power_levels", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "power"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sum_powers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "power"
    t.integer "period"
    t.datetime "created_at", null: false
